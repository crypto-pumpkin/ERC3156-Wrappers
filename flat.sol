...
// File erc3156/contracts/interfaces/IERC3156FlashBorrower.sol@v0.4.7
...
// File erc3156/contracts/interfaces/IERC3156FlashLender.sol@v0.4.7
...
contract UniswapERC3156 is IERC3156FlashLender, UniswapV2FlashBorrowerLike {
     ...
     * Normally getPair(token, weth) & getPair(weth, dai)
     * in Fantom getPair(token, wftm) & getPair(weth, fUSD)
     */
    function getPairAddress(address token) public view returns (address) {
        if (token == dai) return factory.getPair(weth, dai);
